...
//	  used
//	  free
//	  files, total bytes in files, total occupation, total fragmentation
//----------------------------------------------------------------------
...
FileSystem::PrintInfo()
{
    ...
    int i, nBytes;
    int fileHdrSector;
    int nUsedSectors, nFiles = 0, nBytesInFiles = 0, nSectorsOfFiles = 0, nFragSectors = 0;
    ...
    nUsedSectors = NumSectors - freeMap->NumClear();
    printf("Used: %d sectors, %d bytes.\n", nUsedSectors, nUsedSectors * SectorSize);
